...
namespace Tests\Unit\Component\Post\Infrastructure\Repository;
 ...
 */
class PostEntityRepositoryTest extends AppTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->mock = app(PostEntityRepositoryImpl::class);
    }
}
