...
namespace Tests\Unit\Component\Language\Infrastructure\Repository;
 ...
 */
class LanguageRepositoryTest extends AppTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->mock = app(LanguageRepositoryImpl::class);
    }
}
